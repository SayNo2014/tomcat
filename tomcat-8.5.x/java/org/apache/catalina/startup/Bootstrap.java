...
public final class Bootstrap {
    ...
    private void initClassLoaders() {
        try {
        	// 首先初始化common、server、sharedClassloader
    ...
    private ClassLoader createClassLoader(String name, ClassLoader parent)
    	...
    	// 从配置文件（catalina.properties）获取common.loader
        ...
        // RepositoryType.URL：网络上的JAR包资源
        // RepositoryType.DIR : 表示整个目录下的资源包括所有class,jar以及其他资源
        // RepositoryType.JAR : 所有Jar资源
        // RepositoryType.GLOB ： 表示整个目录下的Jar资源，仅仅是*.jar，其他类型忽略

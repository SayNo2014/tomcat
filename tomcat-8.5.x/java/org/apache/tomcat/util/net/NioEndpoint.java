...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    public void startInternal() throws Exception {
    	// 接收器线程的任务是接收请求，并把请求放到请求队列中等待响应，辨识线程的作用是从
    	// 请求队列中取出请求，并把它交给应用处理
        if (!running) {
            running = true;
            paused = false;
    ...
    protected class Acceptor extends AbstractEndpoint.Acceptor {
        ...
        public void run() {
            ...
            // org.apache.tomcat.util.net.NioEndpoint.startInternal中设置running为true
            while (running) {
                ...
                try {
                    ...
                    try {
                        // 调用了serverSock的accpet方法接收一个socket的请求 
